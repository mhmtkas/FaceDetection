...
class Window(QWidget):
    ...
    def play_video(self):
        ...
        capture = cv.VideoCapture(self.link.text())
    ...
    def sendMail(self):
        ...
        self.myMailAddress = "example@gmail.com"              #sending mail should be entered here
        password = "example's password"                       #sending mail's password should be entered here
